...
const Contact = ({ data }) => {
   ...
   console.log(data)
    ...
    const handleClick = (e) => {
       e.preventDefault();
      window.open(`mailto:roopasingam1997@gmail.com?subject=${subject}&body=${name}: ${message}`);
    }
    ...
    return (
      <section id="contact">
         ...
         {/* <h1 style={{textAlign:"center"}}><span >Get In Touch.</span></h1> */}
         <div className="row section-head">
           <h2 > <AutoFlippy text="Contact Me"></AutoFlippy></h2>
            ...
            <aside className="four columns footer-widgets">
               <div className="widget widget_contact">
					   ...
					   <p className="address">
						   ...
						   {data?.address.city}, {data?.address.state} PinCode - {data?.address.zip}<br />
